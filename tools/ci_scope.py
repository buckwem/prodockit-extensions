...
_COMPONENT_FILES: dict[str, frozenset[str]] = {
    ...
    "src/prodockit/diagnostic_readiness.py": frozenset({"diagnostics"}),
    "src/prodockit/table_jinja.py": frozenset({"diagnostics"}),
    ...
    "tools/pdf_runtime_g5_acceptance.py": frozenset({"pdf"}),
    "tools/pdf_configuration_g7_acceptance.py": frozenset({"adopt", "pdf"}),
    "tools/weasyprint_windows_s0.py": frozenset({"pdf"}),
    ...
    ".github/workflows/pdf-runtime-g4.yml": frozenset({"pdf"}),
    ".github/workflows/pdf-runtime-g5.yml": frozenset({"pdf"}),
    ".github/workflows/pdf-configuration-g7.yml": frozenset({"adopt", "pdf"}),
    ".github/workflows/weasyprint-windows-s0.yml": frozenset({"pdf"}),
