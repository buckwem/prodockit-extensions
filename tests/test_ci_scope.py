...
def test_component_runtime_changes_select_only_their_native_matrix() -> None:
    ...
    assert classify(["src/prodockit/environment.py"]) == Scope(
        True, True, True, True, diagnostics=True
    )
...
def test_component_acceptance_and_workflow_files_select_their_own_matrix() -> None:
    for path, component in (
        ...
        (".github/workflows/bootstrap-live-provider-surrey.yml", "bootstrap"),
        (".github/workflows/bootstrap-live-provider-surrey-recovery.yml", "bootstrap"),
        (".github/workflows/bootstrap-live-provider-surrey-connectivity.yml", "bootstrap"),
