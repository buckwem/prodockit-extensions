...
"""Hermetic command harness for the standalone ``pdkboot`` command.
...
class PdkbootCliHarness:
    """Invoke ``pdkboot`` against a deterministic fake machine."""
