...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            CommandResult(1, stderr="Server returned 503"),
        ...
        (
            ...
            CommandResult(
                1,
                stderr="winget did not finish within 1800 seconds.",
            ),
            "command-timeout",
            "no installer or package-manager process is still running",
        ),
        (
            "project-env",
            MACOS,
        ...
        (
            ...
            CommandResult(100, stderr="package installation failed"),
            "alternative-installer",
            "official desktop installer",
        ),
        (
            "node",
            UBUNTU,
            ["sudo", "-E", "bash", "/tmp/nodesource-setup.sh"],
            CommandResult(1, stderr="repository setup failed"),
            "node-repository",
        ...
        (
            ...
            CommandResult(1, stderr="download failed"),
            "linux-pdf-toolchain",
