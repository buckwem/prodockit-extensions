...
|---|---|---|
| A project, installation, or renderer fails unexpectedly | `pdk diag`, then `pdk diag --dry-run` | Nothing until interactive `--apply`; every eligible action has a separate default-No decision and confirmation |
