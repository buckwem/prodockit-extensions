...
| [`diag-repair.yml`](https://github.com/buckwem/prodockit-extensions/blob/main/.github/workflows/diag-repair.yml) | Pull requests, merge groups, pushes to `main`, and manual dispatch | Run the complete diagnostic repair and acceptance fixtures on Ubuntu, Windows, and macOS. The fixtures cover fully repairable, mixed, and ambiguous projects plus transactional rollback and preservation contracts. |
