...
| [`weasyprint-windows-s0.yml`](https://github.com/buckwem/prodockit-extensions/blob/main/.github/workflows/weasyprint-windows-s0.yml) | Changes to the S0 evidence harness; manual dispatch | Verify the pinned official WeasyPrint Windows x64 onedir artifact, render cold and warm fixtures without changing the production runtime, and retain the timings, semantic PDF checks and rendered evidence |
