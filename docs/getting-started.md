...
| `pdf-requirements.txt` | Record Python packages used only by PDF generation. | Move WeasyPrint out of the base requirements and let `pdk pdf` install and validate this file on first use. |
