...
<p>Git is a tool used to manage version control.<span class="zendoc-cite">[<a href="#skou2023">Skoulikari, 2023</a>]</span></p>
...
**Unlike [zendoc.glossary](glossary.md)'s `\gls{id}`**, which inserts a
